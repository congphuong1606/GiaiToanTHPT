...
public class Document2Activity extends AppCompatActivity {
    ...
    private ImageView imvArrowTien;
    private ImageView imvArrowBack;
    private AnimationDrawable animation1,animation;
        ...
        if (core.hasOutline()) {
            mOutlineButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if (mFlatOutline != null) {
                        Intent intent = new Intent(Document2Activity.this, OutlineActivity.class);
...
//    }
    ...
    private void updatePageNumView(int index) {
        ...
        imvArrowTien.setVisibility(View.GONE);
        imvArrowBack.setVisibility(View.GONE);
        if ((index + 1) == core.countPages()&&(index + 1)!=1) {
            imvArrowBack.setVisibility(View.VISIBLE);
        }
        if ((index + 1) != core.countPages()&&(index + 1)==1) {
            imvArrowTien.setVisibility(View.VISIBLE);
        }
        if ((index + 1) != core.countPages()&&(index + 1)!=1) {
            imvArrowTien.setVisibility(View.VISIBLE);
            imvArrowBack.setVisibility(View.VISIBLE);
    ...
    private void makeButtonsView() {
        ...
        tvLesson = (TextView) findViewById(R.id.tv_name_lesson);

        btnBack = (ImageButton) findViewById(R.id.btn_document_back);
        ...
        mSearchClose = (ImageButton) findViewById(R.id.searchClose);
    ...
    public void setGlide() {
        imvArrowTien = (ImageView) findViewById(R.id.imv_arrow_tien);
        imvArrowBack = (ImageView) findViewById(R.id.imv_arrow_back);
        animation = (AnimationDrawable) imvArrowTien.getDrawable();
        animation1 = (AnimationDrawable) imvArrowBack.getDrawable();
        animation.start();
        animation1.start();
//        Glide.get(this).clearMemory();
//        imvArrowTien.setImageDrawable(getResources().getDrawable(R.drawable.animate));
//        imvArrowBack.setImageDrawable(getResources().getDrawable(R.drawable.animate));
//        Glide.with(getApplicationContext()).asGif().load(com.artifex.mupdf.viewer.R.drawable.rowtoi).into(imvArrowTien);
//        Glide.with(getApplicationContext()).asGif().load(com.artifex.mupdf.viewer.R.drawable.gifback).into(imvArrowBack);
    }
